...
/**
 * Slightly modified by Alin-Lucian Stănescu.<br>
 * Modifications made:<br>
 * <li>class Plot.PlotOptions: variable <i>backgroundColor</i> can now also be black to match theme set by the user (dark or light theme) on the app this class was shipped with, and so now the <i>foregroundColor</i> can be white for the back background;</ol><br></li>
 * <li>class Plot.AxisOptions: variable <i>format</i> now represents the Integer number format, not Double, so we don't have Double sums and years on the axis label for the needed implementation</li>
 */
public class Plot {
    ...
    public static class PlotOptions {
        ...
        private Color backgroundColor = Main.displayMode.equals("Light") ? Color.WHITE : Color.BLACK;
        private Color foregroundColor = Main.displayMode.equals("Light") ? Color.BLACK : Color.WHITE;
